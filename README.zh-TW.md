...
這是三套給 Codex 用的 AP 學習技能，支援英文、簡體中文和繁體中文。
...
安裝的是這三個科目資料夾，不是整個儲存庫。裝好後如果沒顯示，可以重新啟動 Codex。
